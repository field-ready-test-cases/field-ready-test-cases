...
// 	@BeforeClass
    ...
    @Property(trials =1000) public void simulateCreateTimeSeriesCopy(@From(SimulateUsageGenerator.class) CopyArgs args) {
        try{
            args.series.createCopy(args.start,args.end);
        } catch(Throwable t){
