...
public class ComputeStatisticsSummary {
	...
	public static class Summary{
		double averageNrExecutedTests = 0;
		int nrBugsDetected = 0;
		String bugsDetected = "";
		double averagePercentageFailing = 0;
	...
	public static void main(String[] args) throws FileNotFoundException, JAXBException {
		...
		String rootDir1 = "<insert_directory>/lang_logs/";
		File rootDirFile1 = new File(rootDir1);
		rootDirFiles.add(rootDirFile1);
		
		String rootDir2 = "<insert_directory>/chart_logs/";
